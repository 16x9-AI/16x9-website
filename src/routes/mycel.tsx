  ...
  return (
    <LegalPage eyebrow="Mycel" title="What Mycel is, and what it can see">
      <p className={legalP}>
        ...
        agents, and read the structured data a task actually needs.
      </p>
      ...
      <p className={legalP}>
        Mycel does not access Gmail, Google Calendar, or Google Drive content. It does not read,
        send, or delete email, does not read or write calendar events, and does not read, upload,
        or modify files. If a future version of Mycel needs any of that, we will ask for a
        separate, explicit scope and update this page before it ships.
      </p>

      {/* PLACEHOLDER - Nelson must confirm data-handling wording */}
      <div>
        <h2 className={legalH2}>How data is used and stored</h2>
        <p className={legalP}>
          Identity and directory information obtained through Google sign-in is used to
          authenticate you, associate your activity with the correct organization inside Mycel,
          and let agents reference basic directory facts, such as who is on a team, when that is
          relevant to a task. This data is stored in Mycel's own database, separate from Google's
          systems, and is only visible to authorized members of your organization and to the 16x9
          team operating Mycel on your behalf.
        </p>
      </div>
